...
<html>
    <head>
        ...
        <script>
            function x() {
                if (document.UpStu.no.value === "" || document.UpStu.fn.value === "" || document.UpStu.ln.value === "" || document.UpStu.add.value === "" || document.UpStu.pno.value === "" || document.UpStu.hno.value === "") {
                    alert("Please fill all details.");
                    return false;
                }            
                if (isNaN(document.UpStu.no.value)) {
                    alert("Please enter valid student number.");
                    return false;
                }
                if (document.UpStu.update.value === "") {
                    alert("Please select Update or Delete.");
                    return false; 
                }
                if (isNaN(document.UpStu.pno.value) || document.UpStu.pno.value.length !== 10) {
                    alert("Please enter valid Phone Number.");
                    return false;
                }
                if (isNaN(document.UpStu.hno.value) || document.UpStu.hno.value.length !== 10) {
